...
namespace PowerUtils.Validations.Tests
{
    ...
    {
        [Fact]
        public void WithoutParameters_Create_Valid()
        {
            // Arrange && Act
        ...
        [Fact]
        public void WithHttpStatusCode_Create_Conflict()
        {
            // Arrange && Act
        ...
        [Fact]
        public void WithoutErrors_Clear_Empty()
        {
            // Arrange
            var act = new ValidationNotifications();
        ...
        [Fact]
        public void WithBadRequest_Clear_Empty()
        {
            // Arrange
            var act = new ValidationNotifications();
        ...
        [Fact]
        public void StatusOK_IsSuccess_True()
        {
            // Arrange && Act
        ...
        [Fact]
        public void StatusAccepted_IsSuccess_True()
        {
            // Arrange && Act
            var notifications = new ValidationNotifications();
        ...
        [Fact]
        public void StatusBadRequest_IsSuccess_False()
        {
            // Arrange && Act
            var notifications = new ValidationNotifications();
        ...
        [Fact]
        public void StatusInternalServerError_IsSuccess_False()
        {
            // Arrange && Act
            var notifications = new ValidationNotifications();
        ...
        [Fact]
        public void StatusContinue_IsSuccess_True()
        {
            // Arrange && Act
            var notifications = new ValidationNotifications();
